...
## Corpus Check
- 62 files · ~195,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 191 nodes · 141 edges · 25 communities detected
...
- `GET()` --calls--> `getCampaignBySlug()`  [INFERRED]
  app/api/cosmic/route.ts → lib/cosmic.ts
- `create_campaign()` --calls--> `GET()`  [INFERRED]
...
Cohesion: 0.17
Nodes (12): deleteCampaign(), getCampaigns(), listCampaigns(), updateCampaign(), handleDonate(), create_campaign(), create_campaign(), create_campaign() (+4 more)
...
Cohesion: 0.5
Nodes (3): CampaignError, CreateCampaign, CreateCampaignArgs
...
- **Thin community `Community 3`** (12 nodes): `page.tsx`, `getCampaignBySlug()`, `getCampaignsByCategory()`, `getCampaignUpdates()`, `getFeaturedCampaigns()`, `getGallery()`, `getRecentDonors()`, `getStories()`, `getTeamMembers()`, `getTestimonials()`, `cosmic.ts`, `CampaignPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 8`** (5 nodes): `campaign.rs`, `Campaign`, `.can_donate()`, `.is_funded()`, `.seeds()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (2 nodes): `program_state.rs`, `ProgramState`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (2 nodes): `Anchor Deploy`, `Solana Devnet Setup`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
