    ...
    <main className="min-h-screen overflow-hidden bg-[#120f0c] px-4 pb-20 pt-28 text-white lg:px-8">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          <div>
            ...
            <motion.div variants={animations.fadeInUp} className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Link
                href="/create"
                onClick={() => trackEvent("campaigns_cta_click", { cta: "create_campaign", section: "hero" })}
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-6 py-3.5 text-sm font-semibold text-white transition duration-300 hover:border-[#d4a853]/30 hover:bg-white/[0.07] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d4a853]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#120f0c]"
              >
          ...
          <motion.div variants={animations.fadeInUp} className="rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-6 backdrop-blur-lg sm:backdrop-blur-2xl sm:p-8">
            <div className="flex items-center justify-between gap-4 border-b border-white/8 pb-5">
              <div>
                <p className="text-[11px] uppercase tracking-[0.28em] text-white/55">Wallet status</p>
              ...
              <div className={cn(
                ...
                connected
                  ...
                  : "border border-white/12 bg-white/[0.05] text-white/72"
              )}>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-[1.4rem] border border-white/10 bg-black/20 p-4">
                <p className="text-[11px] uppercase tracking-[0.22em] text-white/52">Access</p>
              ...
              <div className="rounded-[1.4rem] border border-white/10 bg-black/20 p-4">
                <p className="text-[11px] uppercase tracking-[0.22em] text-white/52">Coverage</p>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <WalletButton />
              {!connected ? (
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs uppercase tracking-[0.22em] text-white/62">
        ...
        <motion.section
          ...
          animate="visible"
          variants={animations.fadeInUp}
          className="mt-8 rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-lg sm:backdrop-blur-xl sm:p-8"
        >
          <StatsGrid
            stats={[
        ...
        <section id="campaign-grid" className="mt-10">
          <div className="flex flex-col gap-5 rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.03))] p-6 backdrop-blur-lg sm:backdrop-blur-xl sm:p-8">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <label className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs uppercase tracking-[0.2em] text-white/68">
                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      setSortBy(value);
                      trackEvent("campaigns_sort_changed", { sort: value });
                    }}
                    className="bg-transparent text-sm font-medium normal-case tracking-normal text-white outline-none focus-visible:ring-2 focus-visible:ring-[#d4a853]/60 rounded"
                  >
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      ...
                      trackEvent("campaigns_filter_changed", { category });
                    }}
                    className={cn(
                      "rounded-full border px-4 py-2 text-sm font-medium capitalize transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d4a853]/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#120f0c]",
                      active
            ...
            <div className="flex flex-wrap gap-2 text-xs text-white/70">
              {[
                ...
                "Direct wallet-to-cause transfer",
                "No platform fee deductions",
              ].map((item) => (
                <span key={item} className="rounded-full border border-white/12 bg-white/[0.04] px-3 py-1.5">
                  {item}
                </span>
              ))}
            </div>
