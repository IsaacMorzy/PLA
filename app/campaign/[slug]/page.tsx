      ...
      <SitePage>
        <PageShell className="max-w-3xl">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.045] px-8 py-14 text-center">
            ...
            <Link
              href="/campaigns"
              className="mt-6 inline-flex items-center justify-center rounded-full bg-[#d4a853] px-6 py-3 text-sm font-semibold text-[#17120d] transition duration-300 hover:bg-[#e5bc68] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d4a853]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#120f0c]"
            >
