            ...
            <CardContent>
              ...
              <div className="space-y-8 text-gray-300">
                <section>
                  ...
                  <p className="text-gray-400">We collect information you provide directly, including name, email, and payment details when making donations. We also collect usage data to improve our services.</p>
                </section>

                <section>
                  <h2 className="text-lg font-semibold text-white mb-3">How We Use Your Information</h2>
                  <p className="text-gray-400">Your information is used to process donations, communicate about campaigns, and provide our services. We never sell your personal data to third parties.</p>
                </section>

                <section>
                  <h2 className="text-lg font-semibold text-white mb-3">Data Protection</h2>
                  <p className="text-gray-400">We implement industry-standard security measures to protect your data. All transactions are encrypted via blockchain technology.</p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-gray-400">For privacy inquiries, reach out to our support team.</p>
                </section>
              </div>
            </CardContent>
          </Card>
