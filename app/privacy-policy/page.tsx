  ...
  return (
    <SitePage>
      <PageShell className="max-w-5xl">
        ...
        <SectionBlock>
          <Card className="rounded-[2rem] border border-black/10 bg-white/75 p-8 sm:p-10 lg:p-12 dark:border-white/10 dark:bg-white/[0.045]">
            <p className="text-sm text-[#6a5441] dark:text-white/58">Last updated: April 2026</p>
            <div className="mt-8 space-y-10 text-[#5c4732] dark:text-white/70 [&_p]:leading-8">
              <section>
                <h2 className="font-display text-3xl text-[#21160c] dark:text-white">Information we collect</h2>
              ...
              <section>
                <h2 className="font-display text-3xl text-[#21160c] dark:text-white">How we use your information</h2>
              ...
              <section>
                <h2 className="font-display text-3xl text-[#21160c] dark:text-white">Data protection</h2>
              ...
              <section>
                <h2 className="font-display text-3xl text-[#21160c] dark:text-white">Your rights</h2>
              ...
              <section>
                <h2 className="font-display text-3xl text-[#21160c] dark:text-white">Contact</h2>
